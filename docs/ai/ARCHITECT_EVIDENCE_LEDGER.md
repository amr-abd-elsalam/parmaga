...
| 7.2 | In Progress — Decision delivery only | اعتماد المالك الصادر في 2026-09-03 نصًّا: «أعتمد فتح المرحلة 7.2 وإصدار ADR-0013 مستقل يعدّل ADR-0012 وفق البنود الأربعة في عقد التسليم»، وbaseline نظيف عند 34e6571 | يشترط إغلاق تسليم القرار: diff محصور في ADR-0013 وREADME.md والدفتر، وصفر Production Code وصفر مساس بـindex.html وassets وtools وtests و.github وADR-0011 و@media print و@page، ونجاح 124 اختبارًا وverify_lesson.py، وdiff --check نظيفًا بـcr-at-eol، وثبات بصمة الطباعة، ونجاح Gate A على PR وعلى main. ولا يبدأ التنفيذ إلا بإذن مالك مستقل بعد دمج القرار وإعطاء baseline جديد |
