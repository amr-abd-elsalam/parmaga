...
سلطة هذه المنطقة ونطاقها: هي أول ما يُقرأ من هذا الدفتر، وتحمل الحالة التشغيلية الراهنة وعقد التسليم النشط. كل قيد جديد يُدرج مباشرة تحت هذا العنوان فيصير أحدث ما فيها، ويهبط ما قبله نحو سطر حدّ الأرشيف. وعقود التسليم تتراكم هنا ولا يُحذف منها شيء: الأعلى موضعًا هو النشط، وما دونه يُقرأ سجلًا منسوخًا. أمر القراءة الافتتاحي المعتمد: `awk '/^### عقد التسليم النشط/{n++} n==2{exit} {print}' docs/ai/ARCHITECT_EVIDENCE_LEDGER.md | head -n 120`، ولا يُقرأ الدفتر كاملًا. وعنوان `### عقد التسليم النشط` سلسلة حاملة لحدّ القراءة لا يُغيَّر نصه، والحدّ 120 سقف أمان لا حدّ قراءة: إن لم يظهر العنوان مرة واحدة بالضبط في المخرَج، أو بلغ المخرَج 120 سطرًا، فهو مبتور أو منفلت ويوجب التوقف. وذكرُ `head -n 80` فيما دون هذا القيد من عقود منسوخة سجلٌّ تاريخي لأمر متقادم، لا تعارض قائم.
