...
دفتر التسليم
المرحلة الحالية: 6.2 — تنفيذ ADR-0009 (V1) وفق عقد ADR-0010
الحالة: In Progress — V1 مرفوع على فرع وPR مفتوح، والدمج موقوف على إغلاق بنود Unknown
HEAD: f990782 | الفرع: feat/adr-0009-0010-lesson-viewer | الشجرة: clean متعقَّبًا، وpycache غير متعقَّب لم يدخل الالتزام
الملفات المعدلة في 6.2: index.html وparmaga.css وlesson-viewer.js وREADME.md والدفتر — خمسة لا سادس لها
الأدلة الجديدة: صفوف §8 المؤرخة 2026-08-31 بوسم 6.2 — خط الأساس والبوابات وحصر النطاق وسبب CRLF وقياس العروض الخمسة وGate A على الـPR
القرارات المعتمدة حرفيًا: ADR-0009 §1–§5 وADR-0010 §2–§10 و§13–§15، وV2 لم يُنفَّذ
الأسئلة المفتوحة: §9 — الفهارس والتنقل بين الدروس؛ وقراءة ADR-0009 §2 لسطر الحالة المخفي بصريًا على الهاتف: اختيار مالك بقراءة مقاصدية لا امتثال حرفي مُثبت
الانحرافات: ثلاثة معلنة — الأدوات الثانوية داخل تدفق الشاشات الواسعة لا خلف details، وقد أثبت قياس 1280 عدم الالتفاف والفيض وسلامة 44×44 فبقي تكبير 200% وحده؛ والقلم متاح في Reduced Motion بطلب صريح لأن المنع النصي يقع على التحميل لا على الطلب؛ وتجاوز حد 40 سطرًا في §21 عند قراءتي B10 وB11
حالة التحقق: 61/61 OK، وverify_lesson.py PASS بصفر أخطاء، وdiff --check نظيف بعد ضبط cr-at-eol، وصفر SVG وmanifest وADR في الفرق، وGate A ناجحة على الـPR، وصفر فيض أفقي وصفر هدف تحت 44×44 في العروض الخمسة
بنود Unknown الباقية: ميزانية اللوحة المفتوحة عند 320، وتكبير 200%، ومعاينة الطباعة، وportrait وlandscape على هاتف حقيقي، وTab وEscape وعودة التركيز، وتغيير viewport مع تركيز داخل التحكم، وReduced Motion على متصفح حقيقي، وCLS مقاسًا، وسجل Console، وقارئ الشاشة
المرحلة التالية الوحيدة: V2 — زر «أعلى الدرس» وفق ADR-0010 §11–§13
شرط بدء المرحلة التالية: إغلاق بنود Unknown في V1 بلا FAIL، ثم إذن مالك منفصل. ويلزم قبله النظر في دليل النسبة: الزر لن يصبح مؤهلًا في النمط التفاعلي على العروض الخمسة
الخطوة التالية الوحيدة: قياس اللوحة المفتوحة عند 320 ثم الجولة اليدوية للتكبير والطباعة ولوحة المفاتيح
