...
- اقرأ عقد التسليم النشط وبيانات المرحلة قبل فحص أي ملف، من المنطقة النشطة في رأس الدفتر بأمر `awk '/^### عقد التسليم النشط/{n++} n==2{exit} {print}' docs/ai/ARCHITECT_EVIDENCE_LEDGER.md | head -n 120`، ويُمنع قراءة الدفتر كاملًا. والحدّ 120 سقف أمان لا حدّ قراءة.
- تحقق من المخرَج قبل الاعتماد عليه: إن لم يحوِ عنوان `### عقد التسليم النشط` مرة واحدة بالضبط، أو بلغ 120 سطرًا، فالمخرَج مبتور أو منفلت — توقف وأبلغ المالك، ولا توصف الحالة بأنها مقروءة.
