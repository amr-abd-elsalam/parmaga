...
- اقرأ عقد التسليم النشط وبيانات المرحلة قبل فحص أي ملف، من المنطقة النشطة في رأس الدفتر بأمر `head -n 80 docs/ai/ARCHITECT_EVIDENCE_LEDGER.md`، ويُمنع قراءة الدفتر كاملًا.
...
توقف قبل أي تعديل عند: HEAD غير المتوقع، أو شجرة غير نظيفة، أو غموض يمنع تعديلًا آمنًا، أو حاجة إلى ملف خارج النطاق، أو اكتشاف أن المرحلة السابقة غير مغلقة. ويُستثنى من «HEAD غير المتوقع» وحده ما تنطبق عليه شروط `Expected Self-Reference Drift` المعرَّفة في `§21` من بروتوكول المعماري، فيُسجَّل بهذا الاسم ويُمضى فيه بإقرار المالك.
